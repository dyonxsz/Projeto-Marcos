export default function EstatisticasPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-4">Estatisticas</h1>
      <p className="text-gray-600 mb-8">Página do NutriSense - estatisticas</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow">
          ...
          <p>Esta é a página de estatisticas do NutriSense.</p>
        </div>
      </div>
    </div>
  )
